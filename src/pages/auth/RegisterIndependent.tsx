    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-3 sm:p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-2">
          ...
          <CardTitle className="text-xl sm:text-2xl font-bold">הרשמה כמשתמש עצמאי</CardTitle>
          <CardDescription className="text-sm sm:text-base">צור חשבון עצמאי במערכת דוחות הנסיעה</CardDescription>
        </CardHeader>
        <CardContent className="px-4 sm:px-6">
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="department">תחום עיסוק *</Label>
              <Input
                id="department"
                name="department"
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                דוחות יישלחו אוטומטית לכתובת זו
              </p>
            </div>
            ...
            <div className="border-t pt-4 space-y-2">
              <div className="bg-green-500/10 p-3 rounded-md border border-green-500/20">
                <p className="text-sm text-muted-foreground">
                  <strong className="text-foreground">משתמש עצמאי:</strong> הדוחות שלך לא דורשים אישור מנהל. יש לך גישה מלאה לסטטיסטיקות והאנליטיקות שלך.
                </p>
              </div>
            </div>
