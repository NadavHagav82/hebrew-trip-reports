...
import { Calculator, Eye, Loader2, ArrowRight, Download, Filter, Search, BarChart3, MessageSquare, Users, ShieldCheck } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" onClick={() => navigate('/accounting/bootstrap-tokens')}>
