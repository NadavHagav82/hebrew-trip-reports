        ...
        messages: [
          {
            ...
            **חשוב מאוד - זיהוי תאריכים:**
            רוב העולם (אירופה, ישראל, אסיה, דרום אמריקה, אפריקה) משתמש בפורמט DD/MM/YYYY או DD/MM/YY.
            רק ארה"ב משתמשת בפורמט MM/DD/YYYY.
            
            כללים לזיהוי תאריך:
            1. אם הקבלה מאירופה (ספרד, צרפת, גרמניה, איטליה וכו') - הפורמט הוא DD/MM/YY
            2. אם הקבלה מישראל - הפורמט הוא DD/MM/YY
            3. אם רואים "FECHA" (ספרדית) - הפורמט הוא DD/MM/YY
            4. אם המספר הראשון גדול מ-12 (למשל 18/11/25) - זה בוודאות יום ולא חודש
            5. שנה דו-ספרתית: 25 = 2025, לא 2018!
            
            דוגמה: 18/11/25 = 2025-11-18 (18 בנובמבר 2025)
